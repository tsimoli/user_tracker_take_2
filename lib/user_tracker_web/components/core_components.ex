defmodule UserTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UserTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UserTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
